...
## Resursų profilis: Device for Heart Rate Measurement 
...
Kitos profilio reprezentacijos: [CSV](../StructureDefinition-device-heart-rate.csv), [Excel](../StructureDefinition-device-heart-rate.xlsx), [Schematron](../StructureDefinition-device-heart-rate.sch) 
