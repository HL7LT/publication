# Resource Lithuanian Vital Signs Implementation Guide
...
```json
{
  ...
  "id" : "lt.hl7.fhir.vitalsigns",
  "language" : "en",
  "url" : "https://hl7.lt/fhir/vitalsigns/ImplementationGuide/lt.hl7.fhir.vitalsigns",
  "version" : "0.0.1",
  "name" : "LTVitalSigns",
  "title" : "Lithuanian Vital Signs Implementation Guide",
  "status" : "draft",
  ...
  "description" : "Lithuanian Vital Signs Implementation Guide",
  "jurisdiction" : [
    {
      "coding" : [
        {
  ...
  "packageId" : "lt.hl7.fhir.vitalsigns",
  "license" : "CC0-1.0",
  "fhirVersion" : ["5.0.0"],
  "dependsOn" : [
    {
    ...
    {
      "id" : "lt_hl7_fhir_base",
      "uri" : "https://hl7.lt/fhir/base/ImplementationGuide/lt.hl7.fhir.base",
  ...
  "definition" : {
    ...
    "resource" : [
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/associated-situation"
        },
        "name" : "Associated Situation Extension",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/bp-cuff-size"
        },
        "name" : "Blood Pressure Cuff Size",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/bp-measurement-body-location"
        },
        "name" : "Blood Pressure Measurement Body Location",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/bp-measurement-method"
        },
        "name" : "Blood Pressure Measurement Method",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/body-height-observation"
        },
        "name" : "Body Height observation codes",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/body-length-unit"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/bmi"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/body-position"
        },
        "name" : "Body Position Extension",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/vital-signs-body-position"
        },
        "name" : "Body Position used in Vital Signs Measurements",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/body-structure-blood-pressure"
        },
        "name" : "Body Structure for Blood Pressure",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/body-weight-associated-situation"
        },
        "name" : "Body Weight Associated Situation",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/device-body-weight"
        },
        "name" : "Body Weight Measurement Device",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/body-weight-observation"
        },
        "name" : "Body Weight observation codes",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/bp-diastolic-observation"
        },
        "name" : "BP Diastolic observation codes",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/bp-panel-observation"
        },
        "name" : "BP Panel observation codes",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/bp-systolic-observation"
        },
        "name" : "BP Systolic observation codes",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/device-blood-pressure"
        },
        "name" : "Device for Blood Pressure Measurement",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/device-body-height"
        },
        "name" : "Device for Body Height Measurement",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/device-heart-rate"
        },
        "name" : "Device for Heart Rate Measurement",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/device-type-blood-pressure"
        },
        "name" : "Device Types for Blood Pressure Measurement",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/device-type-heart-rate"
        },
        "name" : "Device Types for Heart Rate Measurement",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/device-type-height-length"
        },
        "name" : "Device Types for Height Length Measurement",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/device-type-weight"
        },
        "name" : "Device Types for Weight Measurement",
      ...
      },
      {
        ...
        "isExample" : true,
        "profile" : [
          "https://hl7.lt/fhir/vitalsigns/StructureDefinition/blood-pressure-panel|1.0.0"
        ]
      },
      {
        "extension" : [
        ...
        "name" : "Example Body Height Observation",
        "description" : "Example observation representing the patient's body height measured in centimeters.",
        "isExample" : true,
        "profile" : [
          "https://hl7.lt/fhir/vitalsigns/StructureDefinition/body-height|1.0.0"
        ]
      },
      {
        "extension" : [
        ...
        "name" : "Example Body Mass Index Observation",
        "description" : "An example BMI measurement for a patient.",
        "isExample" : true,
        "profile" : [
          "https://hl7.lt/fhir/vitalsigns/StructureDefinition/bmi|1.0.0"
        ]
      },
      {
        "extension" : [
        ...
        "name" : "Example Body Structure for Blood Pressure",
      ...
      },
      {
        ...
        "isExample" : true,
        "profile" : [
          "https://hl7.lt/fhir/vitalsigns/StructureDefinition/body-weight|1.0.0"
        ]
      },
      {
        "extension" : [
        ...
        "name" : "Example Device - Blood Pressure Measurement",
      ...
      },
      {
        ...
        "name" : "Example Device - Body Height Measurement",
      ...
      },
      {
        ...
        "name" : "Example Device - Body Weight Measurement",
      ...
      },
      {
        ...
        "name" : "Example Device - Heart Rate Measurement",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "Observation/example-head-circumference"
        },
        "name" : "Example Head Circumference Observation",
        "description" : "Measured head circumference using a tape measure.",
        "isExample" : true,
        "profile" : [
          "https://hl7.lt/fhir/vitalsigns/StructureDefinition/head-circumference|1.0.0"
        ]
      },
      {
        "extension" : [
        ...
        "isExample" : true,
        "profile" : [
          "https://hl7.lt/fhir/vitalsigns/StructureDefinition/heart-rate|1.0.0"
        ]
      },
      {
        "extension" : [
        ...
        "name" : "Example Patient - Jonas Petrauskas",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "Observation/example-waist-circumference"
        },
        "name" : "Example Waist Circumference Observation",
        "description" : "Measured waist circumference using a tape measure.",
        "isExample" : true,
        "profile" : [
          "https://hl7.lt/fhir/vitalsigns/StructureDefinition/waist-circumference|1.0.0"
        ]
      },
      {
        "extension" : [
        ...
        "reference" : {
          "reference" : "StructureDefinition/exercise-association"
        },
        "name" : "Exercise Association Extension",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/exertion-phase"
        },
        "name" : "Exertion Phase",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/head-circumference"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/heart-rate-measurement-body-location"
        },
        "name" : "Heart Rate Measurement Body Location",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/heart-rate-measurement-method"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/heart-rate-observation"
        },
        "name" : "Heart Rate observation codes",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/height-length-measurement-method"
        },
        "name" : "Height Length Measurement Method",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/measurement-environment"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/measurement-setting"
        },
        "name" : "Measurement Setting Extension",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/numeric-result-interpretation"
        },
        "name" : "Numeric Result Interpretation value set",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/numeric-result-interpretation-non-panic"
        },
        "name" : "Numeric Result Interpretation without panic values, value set",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/vital-signs-rate-unit"
        },
        "name" : "Rate Units",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/sleep-status"
        },
        "name" : "Sleep Status Extension",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/vital-signs-sleep-status"
        },
        "name" : "Sleep Status in Vital Signs Measurements",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "CodeSystem/solor-temporary-codesystem"
        },
        "name" : "SNOMED CT Solor Extension Temporary Code System",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/waist-circumference"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/waist-circumference-obervation"
        },
        "name" : "Waist Circumference observation codes",
    ...
    "parameter" : [
      ...
      },
      {
        ...
        "value" : "https://hl7.lt/fhir/vitalsigns/history.html"
      },
      {
        "code" : {
          "system" : "http://hl7.org/fhir/tools/CodeSystem/ig-parameters",
