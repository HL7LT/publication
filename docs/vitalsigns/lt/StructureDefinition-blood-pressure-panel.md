...
## Resursų profilis: Blood Pressure Panel 
...
* [Device for Blood Pressure Measurement(https://hl7.lt/fhir/vitalsigns/StructureDefinition/device-blood-pressure|1.0.0)](StructureDefinition-device-blood-pressure.md)
...
* [http://hl7.org/fhir/StructureDefinition/observation-componentCategory|5.2.0](http://hl7.org/fhir/extensions/5.2.0/StructureDefinition-observation-componentCategory.html)
...
Kitos profilio reprezentacijos: [CSV](../StructureDefinition-blood-pressure-panel.csv), [Excel](../StructureDefinition-blood-pressure-panel.xlsx), [Schematron](../StructureDefinition-blood-pressure-panel.sch) 
