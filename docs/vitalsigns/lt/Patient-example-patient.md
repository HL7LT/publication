# Example Patient - Jonas Petrauskas - Lithuanian Vital Signs Implementation Guide v0.0.1

## Pavyzdys Patient: Example Patient - Jonas Petrauskas
...
Profile: [LT Base Patient](https://hl7.lt/fhir/base/0.2.0/StructureDefinition-lt-patient.html)
