...
## Resource Profile: Device for Body Height Measurement 
...
Other representations of profile: [CSV](../StructureDefinition-device-body-height.csv), [Excel](../StructureDefinition-device-body-height.xlsx), [Schematron](../StructureDefinition-device-body-height.sch) 
