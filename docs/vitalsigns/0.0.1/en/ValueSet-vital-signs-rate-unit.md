# Rate Units - Lithuanian Vital Signs Implementation Guide v0.0.1

## ValueSet: Rate Units 

 
UCUM rate units for recording vital signs including heart and respiratory rate. 
...
```json
{
  ...
  "url" : "https://hl7.lt/fhir/vitalsigns/ValueSet/vital-signs-rate-unit",
  "version" : "6.0.0",
  "name" : "VitalSignsRateUnit",
  "title" : "Rate Units",
  "status" : "active",
  "experimental" : false,
