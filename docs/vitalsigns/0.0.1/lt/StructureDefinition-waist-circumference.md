...
## Resursų profilis: Waist Circumference 
...
Kitos profilio reprezentacijos: [CSV](../StructureDefinition-waist-circumference.csv), [Excel](../StructureDefinition-waist-circumference.xlsx), [Schematron](../StructureDefinition-waist-circumference.sch) 
