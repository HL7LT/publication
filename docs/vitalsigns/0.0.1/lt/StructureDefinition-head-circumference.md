...
## Resursų profilis: Head Circumference 
...
Kitos profilio reprezentacijos: [CSV](../StructureDefinition-head-circumference.csv), [Excel](../StructureDefinition-head-circumference.xlsx), [Schematron](../StructureDefinition-head-circumference.sch) 
