# Patient: Jonas Petrauskas (example) - Lithuanian Base Implementation Guide v0.3.0

## Pavyzdys Patient: Patient: Jonas Petrauskas (example)
...
Profile: [PatientLt](StructureDefinition-patient-lt.md)
