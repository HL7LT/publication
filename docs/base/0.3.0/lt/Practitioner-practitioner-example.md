# Practitioner: Petras Kazlauskas (example) - Lithuanian Base Implementation Guide v0.3.0

## Pavyzdys Practitioner: Practitioner: Petras Kazlauskas (example)
...
Profile: [PractitionerLt](StructureDefinition-practitioner-lt.md)
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://hl7.lt/fhir/base/StructureDefinition/practitioner-lt"]
  },
  "language" : "en",
  "identifier" : [{
    "use" : "official",
