# Encounter: Psychiatric (example) - Lithuanian Base Implementation Guide v0.3.0

## Pavyzdys Encounter: Encounter: Psychiatric (example)
...
Profile: [EncounterLt](StructureDefinition-encounter-lt.md)
...
| :--- | :--- |
| - | **Reference** |
| * | [Condition Malignant neoplasm of breast](Condition-condition-cancer-example.md) |
...
```json
{
  ...
  "id" : "encounter-psychiatric-example",
  "meta" : {
    "profile" : ["https://hl7.lt/fhir/base/StructureDefinition/encounter-lt"]
  },
  "language" : "en",
  "status" : "completed",
  "class" : [{
