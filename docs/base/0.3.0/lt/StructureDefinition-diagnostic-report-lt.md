...
## Resursų profilis: DiagnosticReportLt 
...
* [BiologicallyDerivedProduct (http://hl7.org/fhir/StructureDefinition/BiologicallyDerivedProduct|5.0.0)](http://hl7.org/fhir/R5/biologicallyderivedproduct.html)
...
* [ImagingStudyLt (https://hl7.lt/fhir/base/StructureDefinition/imagingstudy-lt|0.3.0)](StructureDefinition-imagingstudy-lt.md)
* [GenomicStudy (http://hl7.org/fhir/StructureDefinition/GenomicStudy|5.0.0)](http://hl7.org/fhir/R5/genomicstudy.html)
* [ProcedureLt (https://hl7.lt/fhir/base/StructureDefinition/procedure-lt|0.3.0)](StructureDefinition-procedure-lt.md)
...
* [Citation (http://hl7.org/fhir/StructureDefinition/Citation|5.0.0)](http://hl7.org/fhir/R5/citation.html)
* [CompositionLt (https://hl7.lt/fhir/base/StructureDefinition/composition-lt|0.3.0)](StructureDefinition-composition-lt.md)
...
Kitos profilio reprezentacijos: [CSV](../StructureDefinition-diagnostic-report-lt.csv), [Excel](../StructureDefinition-diagnostic-report-lt.xlsx), [Schematron](../StructureDefinition-diagnostic-report-lt.sch) 
