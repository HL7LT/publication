# ProcedureLt - Lithuanian Base Implementation Guide v0.3.0

## Resursų profilis: ProcedureLt 

 
Lithuanian Base Procedure profile, used for documenting healthcare procedures. 

**Usages:**

* Refer to this Profile: [DiagnosticReportLt](StructureDefinition-diagnostic-report-lt.md), [GoalLt](StructureDefinition-goal-lt.md) and [ImagingStudyLt](StructureDefinition-imagingstudy-lt.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/lt.hl7.fhir.base|current/StructureDefinition/procedure-lt)
...
Kitos profilio reprezentacijos: [CSV](../StructureDefinition-procedure-lt.csv), [Excel](../StructureDefinition-procedure-lt.xlsx), [Schematron](../StructureDefinition-procedure-lt.sch) 
...
```json
{
  ...
  "id" : "procedure-lt",
  "language" : "en",
  "url" : "https://hl7.lt/fhir/base/StructureDefinition/procedure-lt",
  "version" : "0.3.0",
  "name" : "ProcedureLt",
  "title" : "ProcedureLt",
  "status" : "active",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.lt/fhir/base/StructureDefinition/diagnostic-report-lt|0.3.0",
        "https://hl7.lt/fhir/base/StructureDefinition/document-reference-lt|0.3.0",
        "https://hl7.lt/fhir/base/StructureDefinition/composition-lt|0.3.0"]
      }]
    },
    {
      "id" : "Procedure.note",
