...
## Resursų profilis: ServiceRequestLt 
...
* [DetectedIssue (http://hl7.org/fhir/StructureDefinition/DetectedIssue|5.0.0)](http://hl7.org/fhir/R5/detectedissue.html)
...
Kitos profilio reprezentacijos: [CSV](../StructureDefinition-service-request-lt.csv), [Excel](../StructureDefinition-service-request-lt.xlsx), [Schematron](../StructureDefinition-service-request-lt.sch) 
