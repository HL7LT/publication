...
```json
{
  ...
  {
    "id" : "lt_hl7_fhir_eu",
    "uri" : "https://hl7.lt/fhir/eu/ImplementationGuide/lt.hl7.fhir.eu",
  ...
  "definition" : {
    ...
    "resource" : [{
      ...
      "reference" : {
        "reference" : "StructureDefinition/appointment-lt"
      },
      "name" : "AppointmentLt",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/care-plan-lt"
      },
      "name" : "CarePlanLt",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/care-team-lt"
      },
      "name" : "CareTeamLt",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/composition-lt"
      },
      "name" : "CompositionLt",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Condition/condition-cancer-example"
      },
      "name" : "Condition: Cancer (example)",
      "description" : "Example instance of a cancer diagnosis documented during a patient encounter",
      "isExample" : true,
      "profile" : ["https://hl7.lt/fhir/base/StructureDefinition/condition-lt|0.3.0"]
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "StructureDefinition/condition-lt"
      },
      "name" : "ConditionLt",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/diagnostic-report-lt"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/document-reference-lt"
      },
    ...
    },
    {
      ...
      "name" : "Encounter: Psychiatric (example)",
      "description" : "Example of an psychiatric encounter",
      "isExample" : true,
      "profile" : ["https://hl7.lt/fhir/base/StructureDefinition/encounter-lt|0.3.0"]
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "StructureDefinition/encounter-lt"
      },
      "name" : "EncounterLt",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/episode-of-care-lt"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/family-member-history-lt"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/goal-lt"
      },
      "name" : "GoalLt",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/healthcare-service-lt"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/identifier-domain-lt"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/imagingstudy-lt"
      },
      "name" : "ImagingStudyLt",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Location/location-vilnius-hospital-example"
      },
      "name" : "Location: Vilnius Hospital (example)",
      "description" : "Example instance of a healthcare location",
      "isExample" : true,
      "profile" : ["https://hl7.lt/fhir/base/StructureDefinition/location-lt|0.3.0"]
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "StructureDefinition/location-lt"
      },
      "name" : "LocationLt",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Observation/observation-blood-pressure-example"
      },
      "name" : "Observation: Blood Pressure (example)",
      "description" : "Example instance of a blood pressure measurement for a patient",
      "isExample" : true,
      "profile" : ["https://hl7.lt/fhir/base/StructureDefinition/observation-lt|0.3.0"]
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "Observation/observation-breast-density-fatty-example"
      },
      "name" : "Observation: Breast Density Fatty (example)",
      "isExample" : true,
      "profile" : ["https://hl7.lt/fhir/base/StructureDefinition/observation-lt|0.3.0"]
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/observation-lt"
      },
      "name" : "ObservationLt",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/organization-identifier-lt"
      },
    ...
    },
    {
      ...
      "name" : "Organization: Medical Library (example)",
      "description" : "Example of a LMB organization",
      "isExample" : true,
      "profile" : ["https://hl7.lt/fhir/base/StructureDefinition/organization-lt|0.3.0"]
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "Organization/organization-vilnius-hospital-example"
      },
      "name" : "Organization: Vilnius Hospital (example)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/organization-lt"
      },
      "name" : "OrganizationLt",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/patient-identifier-lt"
      },
    ...
    },
    {
      ...
      "name" : "Patient: Jonas Petrauskas (example)",
      "description" : "An example Patient conforming to the Lithuanian Base Profile.",
      "isExample" : true,
      "profile" : ["https://hl7.lt/fhir/base/StructureDefinition/patient-lt|0.3.0"]
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "StructureDefinition/patient-lt"
      },
      "name" : "PatientLt",
    ...
    },
    {
      ...
      "name" : "Practitioner: Petras Kazlauskas (example)",
      "description" : "An example Practitioner conforming to the Lithuanian Base Profile.",
      "isExample" : true,
      "profile" : ["https://hl7.lt/fhir/base/StructureDefinition/practitioner-lt|0.3.0"]
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "StructureDefinition/practitioner-lt"
      },
      "name" : "PractitionerLt",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "PractitionerRole/practitioner-role-doctor-vilnius-hospital-example"
      },
      "name" : "PractitionerRole: Doctor Vilnius Hospital (example)",
      "description" : "An example Practitioner Role conforming to the Lithuanian Base Profile.",
      "isExample" : true,
      "profile" : ["https://hl7.lt/fhir/base/StructureDefinition/practitioner-role-lt|0.3.0"]
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "StructureDefinition/practitioner-role-lt"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/procedure-lt"
      },
      "name" : "ProcedureLt",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "RelatedPerson/related-person-ruta-petrauskiene-example"
      },
      "name" : "RelatedPerson: Rūta Petrauskienė (example)",
      "description" : "An example Related Person conforming to the Lithuanian Base Profile.",
      "isExample" : true,
      "profile" : ["https://hl7.lt/fhir/base/StructureDefinition/related-person-lt|0.3.0"]
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "StructureDefinition/related-person-lt"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/service-request-lt"
      },
    ...
    },
    {
      ...
      "value" : "https://tx.hl7.lt/fhir/CodeSystem/identifier-domain"
    },
    {
      "code" : {
        "system" : "http://hl7.org/fhir/tools/CodeSystem/ig-parameters",
      ...
      "value" : "https://tx.hl7.lt/fhir/ValueSet/patient-identifier"
    },
    {
      "code" : {
        "system" : "http://hl7.org/fhir/tools/CodeSystem/ig-parameters",
      ...
      "value" : "https://tx.hl7.lt/fhir/ValueSet/organization-identifier"
    },
    {
      "code" : {
        "system" : "http://hl7.org/fhir/tools/CodeSystem/ig-parameters",
      ...
      "value" : "http://terminology.hl7.org/ValueSet/EncounterClass"
    },
    {
      "code" : {
        "system" : "http://hl7.org/fhir/tools/CodeSystem/ig-parameters",
