# ObservationLt - Lithuanian Base Implementation Guide v0.3.0

## Resource Profile: ObservationLt 
...
* Refer to this Profile: [DiagnosticReportLt](StructureDefinition-diagnostic-report-lt.md), [EncounterLt](StructureDefinition-encounter-lt.md), [FamilyMemberHistoryLt](StructureDefinition-family-member-history-lt.md), [GoalLt](StructureDefinition-goal-lt.md)... Show 4 more, [ImagingStudyLt](StructureDefinition-imagingstudy-lt.md), [ObservationLt](StructureDefinition-observation-lt.md), [ProcedureLt](StructureDefinition-procedure-lt.md) and [ServiceRequestLt](StructureDefinition-service-request-lt.md)
* Examples for this Profile: [Observation/observation-blood-pressure-example](Observation-observation-blood-pressure-example.md) and [Observation/observation-breast-density-fatty-example](Observation-observation-breast-density-fatty-example.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/lt.hl7.fhir.base|current/StructureDefinition/observation-lt)
...
Other representations of profile: [CSV](../StructureDefinition-observation-lt.csv), [Excel](../StructureDefinition-observation-lt.xlsx), [Schematron](../StructureDefinition-observation-lt.sch) 
...
```json
{
  ...
  "id" : "observation-lt",
  "language" : "en",
  "url" : "https://hl7.lt/fhir/base/StructureDefinition/observation-lt",
  "version" : "0.3.0",
  "name" : "ObservationLt",
  "title" : "ObservationLt",
  "status" : "active",
