...
## Example PractitionerRole: PractitionerRole: Doctor Vilnius Hospital (example)
...
**organization**: [Organization Lietuvos Medicinos biblioteka](Organization-organization-example.md)
