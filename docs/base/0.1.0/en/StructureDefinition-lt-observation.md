...
## Resource Profile: LT Base Observation ( Experimental ) 
...
Other representations of profile: [CSV](../StructureDefinition-lt-observation.csv), [Excel](../StructureDefinition-lt-observation.xlsx), [Schematron](../StructureDefinition-lt-observation.sch) 
