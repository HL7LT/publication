...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile CompositionEu
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Composition">
      <sch:assert test="count(f:extension[@url = 'http://hl7.eu/fhir/imaging-r5/StructureDefinition/im-composition-diagnosticReportReference|0.1.0-ballot']) &gt;= 1">extension with URL = 'http://hl7.eu/fhir/imaging-r5/StructureDefinition/im-composition-diagnosticReportReference|0.1.0-ballot': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.eu/fhir/imaging-r5/StructureDefinition/im-composition-diagnosticReportReference|0.1.0-ballot']) &lt;= 1">extension with URL = 'http://hl7.eu/fhir/imaging-r5/StructureDefinition/im-composition-diagnosticReportReference|0.1.0-ballot': maximum cardinality of 'extension' is 1</sch:assert>
