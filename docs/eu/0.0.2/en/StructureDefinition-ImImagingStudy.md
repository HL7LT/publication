...
Other representations of profile: [CSV](../StructureDefinition-ImImagingStudy.csv), [Excel](../StructureDefinition-ImImagingStudy.xlsx), [Schematron](../StructureDefinition-ImImagingStudy.sch) 
