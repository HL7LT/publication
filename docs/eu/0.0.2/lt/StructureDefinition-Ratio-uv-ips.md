# Ratio (IPS) - HL7 Europe IG Snapshot v0.0.2

## Duomenų tipo profilis: Ratio (IPS) 
...
Kitos profilio reprezentacijos: [CSV](../StructureDefinition-Ratio-uv-ips.csv), [Excel](../StructureDefinition-Ratio-uv-ips.xlsx), [Schematron](../StructureDefinition-Ratio-uv-ips.sch) 
