# IM Imaging Study - HL7 Europe IG Snapshot v0.0.2
...
* [IM WADO Endpoint (http://hl7.eu/fhir/imaging-r5/StructureDefinition/ImWadoEndpoint|0.0.2)](StructureDefinition-ImWadoEndpoint.md)
* [IM Image Viewer Endpoint (http://hl7.eu/fhir/imaging-r5/StructureDefinition/ImImageIidViewerEndpoint|0.0.2)](StructureDefinition-ImImageIidViewerEndpoint.md)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://hl7.eu/fhir/imaging-r5/StructureDefinition/ImWadoEndpoint|0.0.2"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://hl7.eu/fhir/imaging-r5/StructureDefinition/ImImageIidViewerEndpoint|0.0.2"]
      }]
    },
    {
