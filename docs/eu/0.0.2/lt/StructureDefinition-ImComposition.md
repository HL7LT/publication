# IM Composition - HL7 Europe IG Snapshot v0.0.2

## Resursų profilis: IM Composition 
...
Mandatory: 22 elements(2 nested mandatory elements)
...
* [IM Imaging Procedure (http://hl7.eu/fhir/imaging-r5/StructureDefinition/ImProcedure|0.0.2)](StructureDefinition-ImProcedure.md)
* [IM Imaging Order (http://hl7.eu/fhir/imaging-r5/StructureDefinition/ImOrder|0.1.0-ballot)](StructureDefinition-ImOrder.md)
* [IM Imaging Selection (http://hl7.eu/fhir/imaging-r5/StructureDefinition/ImImagingSelection|0.1.0-ballot)](StructureDefinition-ImImagingSelection.md)
* [IM Finding (http://hl7.eu/fhir/imaging-r5/StructureDefinition/ImFinding|0.0.2)](StructureDefinition-ImFinding.md)
* [IM Key Image Document Reference (http://hl7.eu/fhir/imaging-r5/StructureDefinition/ImKeyImageDocumentReference|0.0.2)](StructureDefinition-ImKeyImageDocumentReference.md)
* [IM Key images represented as an ImagingSelection (http://hl7.eu/fhir/imaging-r5/StructureDefinition/ImKeyImageImagingSelection|0.0.2)](StructureDefinition-ImKeyImageImagingSelection.md)
* [EU Condition (http://hl7.eu/fhir/imaging-r5/StructureDefinition/ConditionEu|0.1.0-ballot)](StructureDefinition-ConditionEu.md)
* [EU CarePlan (http://hl7.eu/fhir/imaging-r5/StructureDefinition/CarePlanEu|0.1.0-ballot)](StructureDefinition-CarePlanEu.md)

**Extensions**

This structure refers to these extensions:

* [http://hl7.eu/fhir/imaging-r5/StructureDefinition/im-composition-diagnosticReportReference|0.1.0-ballot](StructureDefinition-im-composition-diagnosticReportReference.md)
* [http://hl7.org/fhir/StructureDefinition/note|5.2.0](http://hl7.org/fhir/extensions/5.2.0/StructureDefinition-note.html)
...
Kitos profilio reprezentacijos: [CSV](../StructureDefinition-ImComposition.csv), [Excel](../StructureDefinition-ImComposition.xlsx), [Schematron](../StructureDefinition-ImComposition.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "CodeableReference",
        "targetProfile" : ["http://hl7.eu/fhir/imaging-r5/StructureDefinition/ImProcedure|0.0.2"]
      }],
      "binding" : {
        "strength" : "extensible",
    ...
    },
    {
      ...
      "constraint" : [{
        ...
        "source" : "http://hl7.eu/fhir/imaging-r5/StructureDefinition/ImComposition|0.0.2"
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://hl7.eu/fhir/imaging-r5/StructureDefinition/ImFinding|0.0.2"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://hl7.eu/fhir/imaging-r5/StructureDefinition/ImKeyImageDocumentReference|0.0.2",
        "http://hl7.eu/fhir/imaging-r5/StructureDefinition/ImKeyImageImagingSelection|0.0.2"]
      }]
    },
    {
