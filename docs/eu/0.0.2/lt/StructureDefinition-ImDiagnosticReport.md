# IM Diagnostic Report - HL7 Europe IG Snapshot v0.0.2
...
* [IM Composition (http://hl7.eu/fhir/imaging-r5/StructureDefinition/ImComposition|0.0.2)](StructureDefinition-ImComposition.md)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://hl7.eu/fhir/imaging-r5/StructureDefinition/ImComposition|0.0.2"]
      }]
    }]
  }
}
