# IM Composition - HL7 Europe General Implementation Guide v0.0.1
...
* [IM Finding (http://hl7.eu/fhir/imaging-r5/StructureDefinition/ImFinding|0.0.1)](StructureDefinition-ImFinding.md)
* [IM Key Image Document Reference (http://hl7.eu/fhir/imaging-r5/StructureDefinition/ImKeyImageDocumentReference|0.0.1)](StructureDefinition-ImKeyImageDocumentReference.md)
* [IM Key images represented as an ImagingSelection (http://hl7.eu/fhir/imaging-r5/StructureDefinition/ImKeyImageImagingSelection|0.0.1)](StructureDefinition-ImKeyImageImagingSelection.md)
