# EU Quantity - HL7 Europe General Implementation Guide v0.0.1

## Duomenų tipo profilis: EU Quantity 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/lt.hl7.fhir.eu|current/StructureDefinition/quantity-eu)
...
Kitos profilio reprezentacijos: [CSV](../StructureDefinition-quantity-eu.csv), [Excel](../StructureDefinition-quantity-eu.xlsx), [Schematron](../StructureDefinition-quantity-eu.sch) 
...
```json
{
  ...
  "url" : "http://hl7.eu/fhir/imaging-r5/StructureDefinition/quantity-eu",
