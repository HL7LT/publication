# ServiceRequest: Laboratory Order (Eu Lab) - HL7 Europe IG Snapshot v0.0.1

## Resursų profilis: ServiceRequest: Laboratory Order (Eu Lab) 
...
* [Coverage (http://hl7.org/fhir/StructureDefinition/Coverage|5.0.0)](http://hl7.org/fhir/R5/coverage.html)
...
Kitos profilio reprezentacijos: [CSV](../StructureDefinition-ServiceRequest-eu-lab.csv), [Excel](../StructureDefinition-ServiceRequest-eu-lab.xlsx), [Schematron](../StructureDefinition-ServiceRequest-eu-lab.sch) 
