# IM Imaging Selection - HL7 Europe General Implementation Guide v0.0.1

## Resursų profilis: IM Imaging Selection 
...
* The element 1 is sliced based on the value of ImagingSelection.derivedFrom
...
Kitos profilio reprezentacijos: [CSV](../StructureDefinition-ImImagingSelection.csv), [Excel](../StructureDefinition-ImImagingSelection.xlsx), [Schematron](../StructureDefinition-ImImagingSelection.sch) 
