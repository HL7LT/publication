# Quantity (Eu Lab) - HL7 Europe General Implementation Guide v0.0.1
...
Other representations of profile: [CSV](../StructureDefinition-Quantity-eu-lab.csv), [Excel](../StructureDefinition-Quantity-eu-lab.xlsx), [Schematron](../StructureDefinition-Quantity-eu-lab.sch) 
