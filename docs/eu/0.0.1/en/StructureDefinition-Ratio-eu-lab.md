# Ratio (Eu Lab) - HL7 Europe General Implementation Guide v0.0.1
...
Other representations of profile: [CSV](../StructureDefinition-Ratio-eu-lab.csv), [Excel](../StructureDefinition-Ratio-eu-lab.xlsx), [Schematron](../StructureDefinition-Ratio-eu-lab.sch) 
