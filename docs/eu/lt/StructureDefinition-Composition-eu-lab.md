...
* [Organization (http://hl7.org/fhir/StructureDefinition/Organization|5.0.0)](http://hl7.org/fhir/R5/organization.html)
* [DiagnosticReport: Laboratory Report (Eu Lab) (http://hl7.eu/fhir/laboratory/StructureDefinition/DiagnosticReport-eu-lab|0.2.0-ci)](StructureDefinition-DiagnosticReport-eu-lab.md)
* [Codeable Concept (IPS) (http://hl7.org/fhir/uv/ips/StructureDefinition/CodeableConcept-uv-ips|2.0.0)](StructureDefinition-CodeableConcept-uv-ips.md)
...
Kitos profilio reprezentacijos: [CSV](../StructureDefinition-Composition-eu-lab.csv), [Excel](../StructureDefinition-Composition-eu-lab.xlsx), [Schematron](../StructureDefinition-Composition-eu-lab.sch) 
