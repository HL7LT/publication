# Quantity (IPS) - HL7 Europe IG Snapshot v0.0.2

## Duomenų tipo profilis: Quantity (IPS) 
...
Kitos profilio reprezentacijos: [CSV](../StructureDefinition-Quantity-uv-ips.csv), [Excel](../StructureDefinition-Quantity-uv-ips.xlsx), [Schematron](../StructureDefinition-Quantity-uv-ips.sch) 
